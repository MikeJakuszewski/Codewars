...
function Journey(object, crew, balloons) {
  (this.object = object), (this.crew = crew), (this.balloons = balloons);
  this.isPossible = function () {
    let weight = Object.values(this.object).reduce((acc, val) => acc + val, 0);
    let crewWeight = this.crew * 80;
    let balloonsStrength = (this.balloons * 4.8) / 1000;

    return balloonsStrength > weight + crewWeight;
  };
}

const test = new Journey(
  { weight1: 0.004536, weight2: 45000, weight3: 95, weight4: 5 },
  2,
  20600
);
